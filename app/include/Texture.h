...
public:
	...
	void update(const void* bytes, GLenum externalFormat, GLenum dataFormat, int cubeMapFace=0);
	...
	std::string getFileName() const;
     ...
     be false.  This is just a flag set for the user's convenience-- it does
