...
public: 
	...
	void SmoothTexture(vector<unsigned char> &t, int siz){
	...
	void FillTexture(vector<unsigned char> &texture, int textsize) {
...
public: 
	...
	void DuplicateTexels(vector<unsigned char> &t, int size);
